...
`;var E=class{constructor(t,...e){this.slotNames=[],this.handleSlotChange=o=>{let i=o.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=e}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){let e=t;if(e.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!e.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function Fi(t){if(!t)return"";let e=t.assignedNodes({flatten:!0}),o="";return[...e].forEach(i=>{i.nodeType===Node.TEXT_NODE&&(o+=i.textContent)}),o}var Uo="";function pe(t){Uo=t}function yo(t=""){if(!Uo){let e=[...document.getElementsByTagName("script")],o=e.find(i=>i.hasAttribute("data-shoelace"));if(o)pe(o.getAttribute("data-shoelace"));else{let i=e.find(r=>/shoelace(\.min)?\.js($|\?)/.test(r.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(r.src)),s="";i&&(s=i.getAttribute("src")),pe(s.split("/").slice(0,-1).join("/"))}}return Uo.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var hr={name:"default",resolver:t=>yo(`assets/icons/${t}.svg`)},Ui=hr;var yi={caret:`
...
`;var Ft=class extends C{constructor(){super(...arguments),this.hasSlotController=new E(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){let t=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()==="sl-dropdown").length>0;if(this.href){this.renderType="link";return}if(t){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return m`
    ...
    `}};Ft.styles=[L,Ri];a([x("slot:not([name])")],Ft.prototype,"defaultSlot",2);a([T()],Ft.prototype,"renderType",2);a([d()],Ft.prototype,"href",2);a([d()],Ft.prototype,"target",2);a([d()],Ft.prototype,"rel",2);a([W("href",{waitUntilFirstUpdate:!0})],Ft.prototype,"hrefChanged",1);Ft.define("sl-breadcrumb-item");var ji=y`
  :host {
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.HA4HDFEK.js.map
